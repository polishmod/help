...
import pl.mil.wp.help.ui.splash.SplashActivity;
...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "pl.mil.wp.help.services.location";
...
//                .setContentText(text)
                ...
                .setContentText(Utils.getLocationTitle(this) )
                .setOngoing(true)
                .setStyle(new NotificationCompat.BigTextStyle().bigText(Utils.getLocationTitle(this)))
...
//                .setTicker(text)
    ...
    private void onNewLocation(Location location) {
        ...
        appDatabaseManager.saveNewLocationToDatabase(location);
